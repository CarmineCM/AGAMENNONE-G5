...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel
        ...
        <iframe style="width: 400px; height: 400px;" id="irm1" src="InsClienti.aspx" runat="server"></iframe>
        <br />
    ...
    <asp:Panel
        ...
        <%--l'iframe è un contenitore che ha la possibilità di richiamare una pagina--%>
        <iframe style="width: 400px; height: 400px;" id="Iframe1" src="ModificaClienti.aspx" runat="server"></iframe>
        <br />
