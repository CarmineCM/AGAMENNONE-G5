...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel
        ...
        <iframe style="width: 400px; height: 400px;" id="irm1" src="../DIPENDENTI/InsDipendente.aspx" runat="server"></iframe>
        <br />
    ...
    <asp:Panel
        ...
        <%--l'iframe è un contenitore che ha la possibilità di richiamare una pagina--%>
        <iframe style="width: 400px; height: 400px;" id="Iframe1" src="../DIPENDENTI/ModificaDipendente.aspx" runat="server"></iframe>
        <br />
