            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-lg-8 col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <asp:Literal ID="ltlDataOra" runat="server">Modifica la data e l'ora</asp:Literal>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <asp:Literal ID="ltlOre" runat="server">Modifica le ore lavorate</asp:Literal>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <asp:Literal ID="ltlKm" runat="server">Modifica il KM</asp:Literal>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <asp:Literal ID="ltlPedaggi" runat="server">Modifica pedaggio</asp:Literal>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <asp:Literal ID="ltlSpeseExtra" runat="server">Modifica le Spese Extra</asp:Literal>
                    ...
                    <div class="card-footer text-center">
                        <asp:Button ID="btnModifica" runat="server" Text="Modifica lavoro" />
                    </div>
